...
('botanical-garden','Explore the Botanical Garden','A slow wander through the conservatory — spot unfamiliar plants, find the Japanese garden, and leave with one photo worth keeping.','Outdoors','🌿',30,0,'easy','gps','solo',null,null,null,array['nature','chill','free','solo'],true,false,null,false,true),
('ramen-spot','Try the New Ramen Spot','Order something outside your comfort zone, eat slowly, and leave a one-sentence review for the next person.','Food','🍜',30,14,'easy','gps','solo',null,null,null,array['food','solo','urban'],true,false,null,false,true),
('campus-mural-hunt','Campus Mural Hunt','Hunt down two pieces of campus art most students walk past every day without noticing.','Art','🎨',15,0,'easy','gps','solo',null,null,null,array['art','campus','free','quick'],false,false,null,false,true),
('library-deep-dive','Library Deep Dive','Explore a library floor you''ve never visited, pull a random book, and leave with one new piece of knowledge.','Learning','📚',30,0,'easy','gps','solo',null,null,null,array['learning','calm','campus','free'],false,false,null,false,true),
('coffee-crawl','Solo Coffee Crawl','Enter a café you''ve never been to, order something unfamiliar, and stay one full drink longer than you planned.','Food','☕',30,5,'easy','gps','solo',null,null,null,array['coffee','solo','chill','urban'],false,false,null,false,true),
...
('group-photo-walk','Group Photo Walk Challenge','A photography challenge for 3–5 friends. Everyone shoots the same prompt list and compares results at the end.','Art','📸',45,0,'easy','gps','group',null,null,null,array['art','group','photo','social','free'],false,false,null,true,true),
('sponsored-climbing','First Climb at Boulder Box','Boulder Box is offering SIDEQUEST users a free first session. No gear needed — they provide everything.','Movement','🧗',45,0,'medium','gps','solo','Boulder Box',null,null,array['movement','sport','sponsored','free'],true,true,'Boulder Box',false,true)
